  ...
  flake = {
    ...
    modules.nixos.velen2077 = {pkgs, ...}: {
      ...
      home-manager.users.velen2077 = {
        home.file = {
          ".face" = {
            source = ../../../assets/home/${config.flake.meta.users.velen2077.username}/.face;
            recursive = true;
          };
          ".face.icon" = {
            source = ../../../assets/home/${config.flake.meta.users.velen2077.username}/.face;
          ...
          "Pictures/Wallpaper/" = {
            source = ../../../assets/home/${config.flake.meta.users.velen2077.username}/Pictures/Wallpaper;
            recursive = true;
          };
        };
      };
